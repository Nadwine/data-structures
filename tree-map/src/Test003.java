/**
 * This class will list all the registration numbers and keepers using a hash map.
...
public class Test003 {
	...
	public static void main (String[]args) {
		...
		System.out.println("== Listing all the registration numbers and keepers == \n");
		dvla.showAllKeepers(dvla.hashMapRegKeeper);
